...
public class RecyclerAdapterProduit extends RecyclerView.Adapter<RecyclerAdapterProduit.ViewHolder> {
    ...
    public RecyclerAdapterProduit(AppCompatActivity appCompatActivity, List<EProduit> items, ItemButtonListener callback) {
        this.items = items;
    ...
    @Override
    public RecyclerAdapterProduit.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.items_produit, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(item!=null)
        {
            ...
            holder.txt_description.setText(item.getDescriptions());
            String date="";
...
//        items.addAll(list_items);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyTextView_Roboto_Regular txt_name,txt_description,txt_date;
