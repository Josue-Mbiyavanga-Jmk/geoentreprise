...
public class RecyclerAdapterCategorieChoix extends RecyclerView.Adapter<RecyclerAdapterCategorieChoix.ViewHolder> {
    private List<ECategorie> items;
    ...
    public RecyclerAdapterCategorieChoix(AppCompatActivity appCompatActivity, List<ECategorie> items, ItemButtonListener callback) {
        this.items = items;
    ...
    @Override
    public RecyclerAdapterCategorieChoix.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                       int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ECategorie item =items !=null ? items.get(position):null;
    ...
    public void add(ECategorie item, int position) {
        items.add(position, item);
        notifyItemInserted(position);
    }

    public void remove(ECategorie item) {
        int position = items.indexOf(item);
        items.remove(position);
        notifyItemRemoved(position);
    }

    public void change(ECategorie item) {
        int position = items.indexOf(item);
    ...
    public void notify(List<ECategorie> list_items) {
